...
<form action="add-annonce-items-post.php" method="post" class="form login">
        <center>
        <h1>Add a announcement Items</h1>
    ...
    <input type="hidden" class="form-control" id="input-connexion" name="categorie" value="items">
